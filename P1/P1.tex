...
\begin{enumerate}[label = (\arabic*)] % Sub-questions styled as italic letters
    ...
    \begin{enumerate}[label=(\arabic*)]
        \item The learning is too slow for \textbf{Zero}, \textbf{One}, \textbf{Uniform} and \textbf{Normal}. In fact, the accuracy does not improve at all.
        \item The learning is effective for \textbf{Normal Xavier}.
        \item The learning is too fast for \textbf{Orthogonal}, \textbf{Truncated Normal}, \textbf{Uniform Xavier}. They do not generalize well compared to Normal Xavier.
    \end{enumerate}
    We will now consider the locally connected network. 
